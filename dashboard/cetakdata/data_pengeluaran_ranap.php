...
include("koneksi.php");
$nama_dokumen='pengeluaran_pertanggal_ranap';
...
$strhtml .="<br>";
$strhtml .="<br>";
$strhtml .= "Berikut ini merupakan data pengeluaran obat untuk Rawat Inap dari Apotik RSPN UNSYIAH : ";
$strhtml .="<br>";
$strhtml .="<br>";
...
<tr>
		...
		$query = ("select *from obat, pengeluaran where obat.id = pengeluaran.id and ruangan='Rawat Inap' and tgl_pengeluaran>='".$_GET['tglawal']."' and tgl_pengeluaran<='".$_GET['tglakhir']."'");
		$no=1;
