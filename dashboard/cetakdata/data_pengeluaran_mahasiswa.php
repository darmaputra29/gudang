...
include("koneksi.php");
$nama_dokumen='pengeluaran_pertanggal_polimahasiswa';
...
<tr>
		...
		$query = ("select *from obat, pengeluaran where obat.id = pengeluaran.id and ruangan='Poli Mahasiswa' and tgl_pengeluaran>='".$_GET['tglawal']."' and tgl_pengeluaran<='".$_GET['tglakhir']."'");
		$no=1;
