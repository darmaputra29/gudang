...
$strhtml .="<br>";
$strhtml .="<br>";
$strhtml .= "Berikut ini merupakan Data Obat Injeksi pada Gudang Obat RSPN UNSYIAH : ";
$strhtml .="<br>";
$strhtml .="<br>";
$strhtml .="<br>";
...
$i=0;
$query = mysql_query("select *from obat where jenis='Injeksi'");
