...
<tr>
		...
		$query = ("select data_buku.judul,data_anggota.id_anggota,data_anggota.nama, trans_pinjam.tgl_pinjam, trans_pinjam.tgl_kembali, trans_pinjam.tgl_dikembalikan, trans_pinjam.status, trans_pinjam.denda from trans_pinjam,data_buku,data_anggota where trans_pinjam.status='kembali' and data_buku.id=trans_pinjam.id and data_anggota.id_anggota=trans_pinjam.id_anggota and  tgl_pinjam>='".$_GET['tglawal']."' and tgl_pinjam<='".$_GET['tglakhir']."'");
		$no=1;
