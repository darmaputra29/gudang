...
$strhtml .="<br>";
$strhtml .="<br>";
$strhtml .= "Berikut ini merupakan Data Obat sirup pada Gudang Obat RSPN UNSYIAH : ";
$strhtml .="<br>";
$strhtml .="<br>";
$strhtml .="<br>";
...
<tr>
                                            ...
                                            <th width='150px'><center>Jenis obat/Satuan</center></th>
  											<td>". date('d F Y', strtotime($data[tgl_masuk_terakhir]))."</td>	
...
$i=0;
$query = mysql_query("select *from obat where jenis='Sirup'");
