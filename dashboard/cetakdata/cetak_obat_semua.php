...
$strhtml .="<br>";
$strhtml .="<br>";
$strhtml .= "Berikut ini merupakan Data Semua Obat pada Gudang Obat RSPN UNSYIAH : ";
$strhtml .="<br>";
$strhtml .="<br>";
$strhtml .="<br>";
...
//$stok=0;
			...
			$strhtml.="
			 <tr class='odd gradeX'>
											...
											<td><center>$r[jumlah_masuk_terakhir] $r[kemasan]</center></td>
											<td class='text-center'><center>$stok2 $r[kemasan]</center></td>
											<td class='text-center'><center>$r[stok] $r[kemasan]</center></td>
