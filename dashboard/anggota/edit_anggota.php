...
?>
<div class="col-lg 12">
    <form action="?menu=proses_edit_anggota" class="form-horizontal" method="post">
        <input type="hidden" name="id" value="<?php echo $row['id_anggota'];?>">
        
         <div class="form-group">
            <label class="col-lg-2 control-label">ID :</label>
            <div class="col-lg-5">
             <input class="form-control" type="text" name="id" value="<?php echo $row['id_anggota'];?>" disabled>
            </div>
        </div>
