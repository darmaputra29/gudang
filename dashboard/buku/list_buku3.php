...
<tr>
                    ...
                    <td> <center><a href='?menu=delete_buku3&id=$r[id]'><i class='fa fa-times-circle-o fa-lg'></i></a> </center></td>
                    <td> <center><a href='?menu=edit_buku3&id=$r[id]'><i class='fa fa-pencil-square-o fa-lg'></i></a> </center></td>
					<td> <center><a href='?menu=detail_buku3&id=$r[id]'><i class='fa fa-file-text fa-lg'></i></a> </center></td>				
                </tr>
    ";
...
?>
	...
	<center><a href="cetakdata/cetak_semua_buku.php"><button type="submit" name="simpan" class="btn btn-primary">Cetak Data</button></a></center>
    </div>
</div>