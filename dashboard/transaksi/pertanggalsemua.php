...
<h2> <b>Semua Pengeluaran Pertanggal</b></h2>
...
$no=0;
$query = mysql_query("select *from obat, pengeluaran where obat.id = pengeluaran.id and tgl_pengeluaran>='$tglawal' and tgl_pengeluaran<='$tglakhir'");
